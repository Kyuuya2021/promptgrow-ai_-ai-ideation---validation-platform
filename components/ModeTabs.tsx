        ...
        {Object.values(Mode).map((mode) => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center space-x-2.5 px-4 py-2 text-sm font-semibold rounded-lg transition-all duration-300 whitespace-nowrap focus:outline-none focus-visible:ring-2 ring-offset-2 ring-offset-[var(--bg-surface)] ring-[var(--primary)] ${
                isActive
                  ? 'text-white'
