...
const ChatPanel: React.FC<ChatPanelProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col bg-[var(--bg-surface)] overflow-hidden relative">
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6" style={{ scrollbarColor: "var(--scrollbar-thumb) var(--scrollbar-track)" }}>
        {showWelcome ? (
          <Welcome mode={mode} />
        ) : (
          messages.map((msg) => (
      ...
      <div className="flex-grow-0 flex-shrink-0 p-2 sm:p-4 pt-2 bg-gradient-to-t from-[var(--bg-surface)] to-transparent">
